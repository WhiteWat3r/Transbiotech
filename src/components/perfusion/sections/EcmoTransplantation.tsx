...
export const EcmoTransplantation = () => {
  ...
  return (
    ...
    <div className="w-full relative flex flex-col mt-[80px] desktop:flex-row desktop:mt-[170px] desktop:gap-[50px] max-w-[1440px] mx-auto desktop:pr-[80px]">
      <img src={isDesktop ? ecmoTransplantationDesc: ecmoTransplantation} alt="" className="deskop:w-[578px] desktop:h-[603px]"/>
      <div className="relative pt-[40px] flex w-full  flex-col px-[20px] desktop:px-0  desktop:pt-0">
        ...
        />
        <p className="mob-head-3 my-[50px] text-grey-2 desktop:head-4 desktop:my-[85px]">
    ...
    <div className="px-[20px] desktop:px-[80px] max-w-[1440px] w-full mx-auto desktop:mb-[62px]">
    <DeviceInfo
          advantages={[
