...
export const PerfusionTechnologies = () => {
  return (
    <div className="relative mx-auto mt-[80px] flex w-full max-w-[1440px] flex-col gap-[45px] px-[20px] desktop:px-[80px]">
      <h2 className={`head-1 desktop:head-1 absolute bottom-0 text-gainsboro`}>
        техн
        <wbr />
        оло
        <wbr />
      ...
      <ul className="relative z-10 grid grid-cols-2 gap-[19px] desktop:grid-cols-3">
        {perfusionCards.map((card) => (
          ...
          <li className="flex h-[149px] flex-col justify-between rounded-[25px] bg-[#FFFFFF] bg-opacity-30 p-[20px]  desktop:h-[177px] desktop:p-[30px]">
