...
export const SectionMain = () => {
  ...
  return (
    <div className="relative h-[calc(100vh-75px)] w-full bg-cover">
      <img
      ...
      <div className="relative z-[3] flex min-h-[63%] w-full flex-col justify-between px-5 pt-[38px] tablet:pt-[10px] desktop:min-h-[56%] desktop:px-[80px] desktop:pt-0">
        <div className="ml-auto max-w-[218px] text-[14px] leading-[16px] text-[#565656] desktop:mr-[265px] desktop:mt-[52px] desktop:max-w-[333px] desktop:text-[22px] desktop:leading-[26px]">
          <p className="">
            {
        ...
        <ul className="mb-[20px] flex max-w-[240px] flex-wrap gap-[10px] desktop:mb-[25px] desktop:max-w-[100%] desktop:gap-[20px]">
          {buttons.map((btn, index) => (
            <li key={btn.id}>
              <button
                className={`geologica-text " flex h-[30px] animate-glow items-center justify-center rounded-[45px] bg-white px-[11px] text-[12px] font-medium text-[#212121] transition-all duration-300 desktop:h-[38px] desktop:animate-none desktop:text-[18px] desktop:leading-[22px] desktop:hover:translate-y-[-10px] desktop:hover:transform desktop:hover:bg-[var(--btn-color)] desktop:hover:text-white`}
                style={
                  {
      ...
      <h1 className="geologica-text z-1 px-5 text-[46px] font-semibold leading-[44px] text-[#565656] desktop:px-[80px] desktop:text-[110px] desktop:leading-[100px]">
