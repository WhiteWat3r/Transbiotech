  ...
  return (
    <div className="mx-auto flex w-full max-w-[1440px] flex-col desktop:px-[80px]">
      <div className="relative mt-[86px] w-full desktop:mt-[232px]">
        ...
        />
        <img
          src={isDesktop ? shadowDesktop : shadow}
          alt=""
        ...
        <div className="mt-[140px] w-full px-[20px] desktop:ml-auto desktop:w-[352px] desktop:mt-[65px]">
          <h2 className="mob-head-2 mb-[15px] whitespace-pre-wrap text-grey-2 desktop:head-4 desktop:mb-[25px]">{`аппарат\nEx-Stream`}</h2>
          <p className="mob-text-3 mb-[80px] text-grey-2 desktop:text-4">{`Аппарат предназначен для организации искусственного кровообращения для повышения эффективности оказания помощи\nв реаниматологии, трансплантологии, онкологии, кардиологии.`}</p>
        </div>
      </div>
    </div>
  );
