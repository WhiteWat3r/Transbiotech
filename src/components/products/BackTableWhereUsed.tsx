...
export const BackTableWhereUsed = () => {
  ...
  return (
    <div className="relative mx-auto mb-[170px] w-full max-w-[1440px] desktop:mb-0">
      <img src={tube} alt="" className="absolute" />

      <div className="flex w-full flex-col px-[20px] 1200:flex-row-reverse 1200:gap-[72px] 1200:px-[80px] 1200:pt-[50px]">
