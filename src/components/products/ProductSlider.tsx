...
export const ProductSlider = ({
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-col items-center rounded-[28px] bg-gainsboro bg-opacity-45 p-[25px] desktop:rounded-[45px] desktop:pb-[40px] desktop:pt-[42px]">
        <Swiper
          spaceBetween={10}
          slidesPerView={1}
          onSlideChange={(swiper) => setActiveIndex(swiper.realIndex)}
          className="w-full max-w-[450px] rounded-[22px] desktop:rounded-[35px]"
          loop
        ...
        <div className="mt-[31px] flex w-full justify-between gap-[15px] desktop:mt-[52px] desktop:gap-[25px] desktop:px-[12px]">
        ...
        <ul className="mt-[25px] flex justify-between gap-[15px] desktop:mt-[40px] desktop:gap-[25px] desktop:px-[12px]">
          {devicePhotos.map((photo, index) => (
            <li
              key={index}
