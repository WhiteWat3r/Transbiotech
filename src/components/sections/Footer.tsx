...
export const Footer = () => {
  ...
  return (
    <footer className="relative flex h-[700px] w-full flex-col justify-center overflow-hidden px-[20px] desktop:h-[770px] desktop:justify-end desktop:pl-[80px] desktop:pr-0">
      <img
      ...
      <div className="desktop:rounded-0 relative mt-[80px] flex h-[635px] w-full flex-col rounded-[25px] bg-white p-[40px] pb-[25px] desktop:mt-[30px] desktop:h-[600px] desktop:rounded-t-none desktop:rounded-tl-[45px] desktop:p-[80px] desktop:pl-[29.5vw]">
